    ...
    //        rsh.y3 += 20;
        ...
        if(choice == "sq") {
            ...
            if(flag) {
                ...
                b[sq.x2][sq.y2] = 1;
                b[sq.x3][sq.y3] = 1;
                blocks++;char aa[10];sprintf(aa,"Blocks: %d, Points: %d, Lines: %d",blocks,points,lines);
...
LRESULT CALLBACK WndProc(HWND hwnd, UINT msg, WPARAM wParam, LPARAM lParam)
{
  ...
  // //thrad = CreateThread(NULL, 0, paintMe, NULL, 0, NULL);
                ...
                threa = CreateThread(0, 0, downs, 0, 0, NULL);
                //srand(time(NULL));
                prep();
                fist = FALSE;
            }
        ...
        case WM_CREATE:
        {
            int y = 600; int h = 48;
            int x = 443; int w = 124;
  	    hwnd_new_game = CreateWindowEx(0, "BUTTON", "> Restart Play <", WS_TABSTOP | WS_VISIBLE | WS_CHILD | BS_DEFPUSHBUTTON,
